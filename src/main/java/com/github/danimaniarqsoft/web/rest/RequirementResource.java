...
/**
 * REST controller for managing {@link com.github.danimaniarqsoft.domain.Requirement}.
 */
@RestController
...
public class RequirementResource {
    ...
    public Mono<ResponseEntity<RequirementDTO>> createRequirement(@Valid @RequestBody RequirementDTO requirementDTO)
        ...
        return requirementService.save(requirementDTO).map(result -> {
            try {
    ...
    public Mono<ResponseEntity<RequirementDTO>> updateRequirement(
        ...
        return requirementRepository.existsById(id).flatMap(exists -> {
            if (!exists) {
    ...
    public Mono<ResponseEntity<List<RequirementDTO>>> getAllRequirements(
        ...
        return requirementService
            .countAll()
            .zipWith(requirementService.findAll(pageable).collectList())
     ...
     */
    @GetMapping("/{id}")
    public Mono<ResponseEntity<RequirementDTO>> getRequirement(@PathVariable("id") String id) {
